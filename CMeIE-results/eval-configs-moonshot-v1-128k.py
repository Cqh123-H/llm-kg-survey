datasets=[
    dict(abbr='medbench-CMeIE',
        eval_cfg=dict(
            evaluator=dict(
                type='opencompass.datasets.MedBenchEvaluator_CMeIE'),
            pred_role='BOT'),
        infer_cfg=dict(
            inferencer=dict(
        ...
        type='opencompass.datasets.MedBenchDataset'),
    ]
infer=dict(
    partitioner=dict(
...
models=[
    dict(abbr='moonshot-v1-128k',
        batch_size=1,
        key='',
        max_out_len=2048,
        max_seq_len=2048,
        path='moonshot-v1-128k',
        query_per_second=1,
        system_prompt='你是 Kimi，由 Moonshot AI 提供的人工智能助手，你更擅长中文和英文的对话。你会为用户提供安全，有帮助，准确的回答。同时，你会拒绝一些涉及恐怖主义，种族歧视，黄色暴力等问题的回答。Moonshot AI 为专有名词，不可翻译成其他语言。',
        type='opencompass.models.MoonShot',
        url=''),
    ]
summarizer=dict(
    dataset_abbrs=[
        ...
        'gorrila_simple_norm',
        'gorrila_multi_norm',
        'gorrila_parallel_norm',
        'gorrila_parallel_multiple_norm',
        '--------- gorrila_zh ---------',
        'gorrila_simple_zh_norm',
        'gorrila_multiple_zh_norm',
        'gorrila_parallel_zh_norm',
        'gorrila_parallel_multiple_zh_norm',
        '--------- teval ---------',
        'teval-data_instruct_v2_zh',
        'teval-data_plan_json_v2_zh',
        'teval-data_plan_str_v2_zh',
        'teval-data_review_str_v2_zh',
        'teval-data_reason_retrieve_understand_json_v2_zh',
        'teval-data_reason_str_v2_zh',
        'teval-data_retrieve_str_v2_zh',
        'teval-data_understand_str_v2_zh',
        ],
    summary_groups=[
        ...
        dict(metric='format_metric',
            name='teval-data_instruct_v2',
            subsets=[
                [
                        'teval-data_instruct_v2',
        ...
        dict(name='copy_teval-review_str_v1',
            subsets=[
                [
                        'teval-review_str_v1',
                        'review_quality',
        ...
        dict(metric='acc',
            name='gorrila_parallel_multiple',
            subsets=[
                [
                        'parallel_multiple',
                        'acc',
...
work_dir='outputs/api_moonshot/medbench/'